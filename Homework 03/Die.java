...
public class Die {
   ...
   */
   public Die( int nSides ) {
     if(nSides < MINIMUM_SIDES){
       throw new IllegalArgumentException("Can't roll the dice because you need a minimum of 4 sides.");
     }else{
       sides = nSides;
     }
     //return sides;
   ...
   */
   public int roll() {
     ...
     double calc = (rand * sides) + 1;
     pips = (int)calc;
     return pips;
     // pips = Math.floor(Math.random(sides) + 1);
     // return pips;
   }
   ...
   */
   public int getValue() {
     // if(pips == null){
     //   throw new IllegalArgumentException("You need to roll the die before getting a value");
     // }
      return pips;
   }
   ...
   * @throws      IllegalArgumentException
   */
   //reset the sides on the die ex: 10 to 12 sides
